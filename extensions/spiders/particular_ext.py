...
class ParticularExtSpider(scrapy.Spider):
    ...
    # 相应改变1
    start_urls =['https://chrome.google.com/webstore/detail/360cities-tab-extension/hfnanlgchfeafhhabjagfmnnjcogfhaf']
    ...
    def parse(self, response):
        ...
        # 响应改变2
        ext_code_id = 'hfnanlgchfeafhhabjagfmnnjcogfhaf'
